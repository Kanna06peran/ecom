    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
       ...
       bg-gradient-to-b from-cyan-100/70'></div>
        ...
        text-course-deatails-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>EMC</span></p>
                      ...
                      {chapter.chapterContent.map((lecture, i)=>(
                        <li className='flex items-start gap-2  py-1 ' key={i}>
                          ...
                          text-gray-800 text-xs md:text-default'>
                            <p className='pt-1'>{lecture.lectureTitle}</p>
                            <div className='flex gap-2'>
                              ...
                              <p className='pr-3'>{humanizeDuration(lecture.lectureDuration * 60 * 1000,{units:['h','m']})}</p>
                            </div>
                          </div>
        ...
        md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'> 
            ...
            <div className='flex gap-3 items-center pt-2'>
              ...
              <p className='nd:text-lg text-gray-500'>{courseData.discount}% off</p>
            </div>
